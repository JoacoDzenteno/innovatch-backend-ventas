...
Repositorio del microservicio de ventas de la tienda Innovatech, desarrollado con Spring Boot y Java.
...
- `Springboot-API-REST/` — código fuente del microservicio
...
Se utilizó un **named volume** (`db_data_innovatech`) para la base de datos MySQL. Este volumen asegura que toda la información crítica almacenada en la base de datos, como registros de ventas y transacciones, no se pierda al reiniciar o detener los contenedores.
...
3. Garantiza que los datos de ventas y transacciones persistan independientemente de reinicios, actualizaciones o recreación de contenedores.
